...
window.WUT_TEAM = [
    ...
    { slug: 'stefan-jozefowicz-okonkwo', name: 'Stefan Józefowicz-Okonkwo', dept: 'aero' },
    {
        ...
        achievements: [{ year: 2025, text: 'POLSKA' }],
    ...
    { slug: 'mikolaj-cieslak', name: 'Mikołaj Cieślak', dept: 'chassis', role: 'Zastępca koordynatora' },
    {
        ...
        achievements: [{ year: 2024, text: 'FS Poland' }, { year: 2025, text: 'FS Poland' }],
    ...
    { slug: 'tomek-kolakowski', name: 'Tomek Kołakowski', dept: 'suspension' },
    {
        ...
        achievements: [{ year: 2025, text: 'FSA' }, { year: 2025, text: 'FSP' }],
    ...
    },
    {
        ...
        achievements: [{ year: 2025, text: 'Formula student Austria' }],
    ...
    { slug: 'blazej-molas', name: 'Błażej Molas', dept: 'electronics', role: 'Zastępca koordynatora' },
    {
        ...
        achievements: [{ year: 2024, text: 'Węgry' }, { year: 2025, text: 'Austria Czechy Polska' }],
    ...
    },
    {
        ...
        achievements: [{ year: 2022, text: 'Czechy' }, { year: 2023, text: 'Węgry' }, { year: 2023, text: 'Niemcy' }, { year: 2023, text: 'Polska' }, { year: 2024, text: 'Węgry' }, { year: 2024, text: 'Chorwacja' }, { year: 2024, text: 'Polska' }, { year: 2025, text: 'Austria' }, { year: 2025, text: 'Polska' }],
    ...
    // SILNIK
    {
        ...
        achievements: [{ year: 2024, text: 'Polska' }, { year: 2025, text: 'Czechy' }, { year: 2025, text: 'Polska' }],
    ...
    { slug: 'mikolaj-klonowski', name: 'Mikołaj Klonowski', dept: 'engine' },
    {
        ...
        achievements: [{ year: 2023, text: 'FS Austria' }],
